...
namespace Ciclope.Controllers
{
    ...
    [Route("api/DividaAT")]
    [ApiController]
    public class DividaATControllerAPI : ControllerBase
    {
        ...
        public DividaATControllerAPI(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{apiKey}")]
        public async Task<ActionResult<IEnumerable<DividaAT>>> GetDividaAT(string apiKey, string startDate, string endDate)
        {
            ...
            return await _context.DividaAT.Where(e => e.EmpresaId == empresa.Id && (e.Data >= startDate_ || startDate_ == null) && (e.Data <= endDate_ || endDate_ == null)).OrderBy(e => e.Data).ToListAsync();
        }
