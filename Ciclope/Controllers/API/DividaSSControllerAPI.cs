...
namespace Ciclope.Controllers
{
    ...
    [Route("api/DividaSS")]
    [ApiController]
    public class DividaSSControllerAPI : ControllerBase
    {
        ...
        public DividaSSControllerAPI(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{apiKey}")]
        public async Task<ActionResult<IEnumerable<DividaSS>>> GetDividaSS(string apiKey,  string startDate, string endDate)
        {
            ...
            return await _context.DividaSS.Where(e => e.EmpresaId == empresa.Id && (e.Data >= startDate_ || startDate_ == null) && (e.Data <= endDate_ || endDate_ == null)).OrderBy(e => e.Data).ToListAsync();
        }
