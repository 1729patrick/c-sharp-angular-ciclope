    ...
    public class IESTest
    {
        ...
        public async Task Test_GetList()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                context.TBL_Doc_IES.AddRange(
                    new TBL_Doc_IES { DataValidade = DateTime.Now, IdEmpresa = 1 },
                    new TBL_Doc_IES { DataValidade = DateTime.Now, IdEmpresa = 1 },
                    new TBL_Doc_IES { DataValidade = DateTime.Now, IdEmpresa = 1 });
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var controller = new IESController(context, manager);

                var result = await controller.Index(1);

                var viewResult = Assert.IsType<ViewResult>(result);
                var model = Assert.IsAssignableFrom<IEnumerable<TBL_Doc_IES>>(viewResult.ViewData.Model);
        ...
        public async Task Test_GetDetails()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var viewResult = Assert.IsType<ViewResult>(result);
                var model = Assert.IsAssignableFrom<TBL_Doc_IES>(viewResult.ViewData.Model);
        ...
        public async Task Test_Update()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var viewResult = Assert.IsType<Ciclope.Models.TBL_Doc_IES>(okResult.Model);

                // viewResult.DataValidade = DateTime.Now;
                ...
                // viewResult = Assert.IsType<Ciclope.Models.TBL_Doc_IES>(okResult.Model);

                // Assert.Equal(DateTime.Now, viewResult.DataValidade);
            }
        }
        ...
        public void Test_GetPaginaListagem()
        {
            ...
            Thread.Sleep(1000);
            driver.ExecuteScript("document.getElementById('IES').click()");
            Thread.Sleep(1000);
            Assert.Contains("https://ciclope.azurewebsites.net/IES/Index", driver.Url);
            driver.Dispose();
        }
        ...
        public void Test_GetPaginaDetails()
        {
            ...
            Assert.Contains("https://ciclope.azurewebsites.net/IES/Details/", driver.Url);
            driver.Dispose();
        }
        ...
        public void Test_GetPaginaUpdate()
        {
            ...
            Assert.Contains("https://ciclope.azurewebsites.net/IES/Edit/", driver.Url);
            driver.Dispose();
        }
        ...
        public void Test_GetPaginaDelete()
        {
            ...
            Assert.Contains("https://ciclope.azurewebsites.net/IES/Delete/", driver.Url);
            driver.Dispose();
        }
        ...
        public void Test_GetPaginaCreate()
        {
            ...
            Assert.Contains("https://ciclope.azurewebsites.net/IES/Create", driver.Url);
            driver.Dispose();
        }
        #endregion
