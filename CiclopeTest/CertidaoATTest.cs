    ...
    public class CertidaoATTest
    {
        ...
        public async Task Test_GetList()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var controller = new CertidaoATController(context, manager);

                var result = await controller.Index(1);

                var viewResult = Assert.IsType<ViewResult>(result);
                var model = Assert.IsAssignableFrom<IEnumerable<TBL_Doc_CertidaoAT>>(viewResult.ViewData.Model);
        ...
        public async Task Test_GetDetails()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var viewResult = Assert.IsType<ViewResult>(result);
                var model = Assert.IsAssignableFrom<TBL_Doc_CertidaoAT>(viewResult.ViewData.Model);
        ...
        public async Task Test_Update()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var viewResult = Assert.IsType<Ciclope.Models.TBL_Doc_CertidaoAT>(okResult.Model);


                viewResult.CodigoValidacao = "3";
                ...
                viewResult = Assert.IsType<Ciclope.Models.TBL_Doc_CertidaoAT>(okResult.Model);

                Assert.Equal("3", viewResult.CodigoValidacao);
            }
        }
