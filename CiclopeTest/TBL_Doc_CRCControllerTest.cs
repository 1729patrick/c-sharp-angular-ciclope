...
namespace CiclopeTest
{
    public class TBL_Doc_CRCControllerTest
    {
        #region Unit Test
        [Fact]
        public async Task Test_GetListCRC()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                context.SaveChanges();
                context.TBL_Doc_CRC.AddRange(
                    new TBL_Doc_CRC { Nome = "A", IdEmpresa = 1 },
                    new TBL_Doc_CRC { Nome = "B", IdEmpresa = 1 },
                    new TBL_Doc_CRC { Nome = "C", IdEmpresa = 1 });
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var controller = new TBL_Doc_CRCController(context, manager);

                var result = await controller.Index(1);

                var viewResult = Assert.IsType<ViewResult>(result);
                var model = Assert.IsAssignableFrom<IEnumerable<TBL_Doc_CRC>>(viewResult.ViewData.Model);
                Assert.Equal(3, model.Count());
            }
        }

        [Fact]
        public async Task Test_GetDetailsCRC()
        {
            var useridTest = Guid.NewGuid().ToString();
            var connection = new SqliteConnection("DataSource=:memory:");
            connection.Open();
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var viewResult = Assert.IsType<ViewResult>(result);
                var model = Assert.IsAssignableFrom<TBL_Doc_CRC>(viewResult.ViewData.Model);
                Assert.Equal(1, model.Id);
            }
        }

        [Fact]
        public async Task Test_UpdateCRC()
        {
            var useridTest = Guid.NewGuid().ToString();
            var connection = new SqliteConnection("DataSource=:memory:");
            connection.Open();
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                var viewResult = Assert.IsType<TBL_Doc_CRC>(okResult.Model);
                ...
                viewResult = Assert.IsType<TBL_Doc_CRC>(okResult.Model);

                Assert.Equal("AA", viewResult.Nome);
            }
        }

        [Fact]
        public async Task Test_DeleteCRC()
        {
            var useridTest = Guid.NewGuid().ToString();
            var connection = new SqliteConnection("DataSource=:memory:");
            connection.Open();
        ...
        [Fact]
        public async Task Test_CreateCRC()
        {
            var useridTest = Guid.NewGuid().ToString();
            var connection = new SqliteConnection("DataSource=:memory:");
            connection.Open();
